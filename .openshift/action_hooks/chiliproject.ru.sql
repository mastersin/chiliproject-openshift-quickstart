-- MySQL dump 10.13  Distrib 5.1.56, for alt-linux-gnu (x86_64)
--
-- Host: localhost    Database: chiliproject
-- ------------------------------------------------------
...
CREATE TABLE `auth_sources` (
  ...
  `custom_filter` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `enumerations` VALUES (1,'Пользовательская документация',1,0,'DocumentCategory',1,NULL,NULL),(2,'Техническая документация',2,0,'DocumentCategory',1,NULL,NULL),(3,'Низкий',1,0,'IssuePriority',1,NULL,NULL),(4,'Нормальный',2,1,'IssuePriority',1,NULL,NULL),(5,'Высокий',3,0,'IssuePriority',1,NULL,NULL),(6,'Срочный',4,0,'IssuePriority',1,NULL,NULL),(7,'Немедленный',5,0,'IssuePriority',1,NULL,NULL),(8,'Проектирование',1,0,'TimeEntryActivity',1,NULL,NULL),(9,'Разработка',2,0,'TimeEntryActivity',1,NULL,NULL);
...
INSERT INTO `issue_statuses` VALUES (1,'Новая',0,1,1,NULL),(2,'В работе',0,0,2,NULL),(3,'Решена',0,0,3,NULL),(4,'Обратная связь',0,0,4,NULL),(5,'Закрыта',1,0,5,NULL),(6,'Отказ',1,0,6,NULL);
...
CREATE TABLE `journals` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `journaled_id` int(11) NOT NULL DEFAULT '0',
  ...
  `type` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `journals_journalized_id` (`journaled_id`),
  KEY `index_journals_on_user_id` (`user_id`),
  KEY `index_journals_on_journalized_id` (`journaled_id`),
  KEY `index_journals_on_created_on` (`created_at`),
  KEY `index_journals_on_journaled_id` (`journaled_id`),
  KEY `index_journals_on_activity_type` (`activity_type`),
  KEY `index_journals_on_created_at` (`created_at`),
  KEY `index_journals_on_type` (`type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `queries` (
  ...
  `display_subprojects` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `trackers` VALUES (1,'Ошибка',1,1,0),(2,'Изменение',1,2,1),(3,'Поддержка',0,3,0);
...
INSERT INTO `users` VALUES (1,'admin','7e271d3f98f222f43814de3a25480ad0f45305a0','ChiliProject','Admin','admin@example.net',1,1,NULL,'en',NULL,'2012-08-01 22:34:00','2012-08-01 22:34:00','User',NULL,'all','7d33dde3d8db25b0a2d69844760f2e35'),(2,'','','','Anonymous','',0,0,NULL,'',NULL,'2012-08-01 22:34:40','2012-08-01 22:34:40','AnonymousUser',NULL,'only_my_events',NULL);
...
-- Dump completed on 2012-08-02  0:49:23
